...
public class AppConstants {
	...
	public static final String PARAM_FOR_ADDRESS_SELECT = "address_selcet";//地址选择
	public static final String PARAM_FOR_SHOPTYPE_SELECT = "shoptype_selcet";//到站选择

	public static final String REQUEST_CODE_TOKEN_INVALID = "001000";//token无效 单点登录
	...
	public static final String PARAM_HISTORY_SEARSH = "PARAM_HISTORY_SEARSH";
	/**
	 * 分页请求页数从1开始
	 */
